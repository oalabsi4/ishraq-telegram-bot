...
export const DateKeyboard = [
  [
    { text: Arabic.PastMonth, callback_data: 'past_month' },
    { text: Arabic.PastYear, callback_data: 'past_year' },
  ],
  [
    { text: Arabic.ThisWeek, callback_data: 'this_week' },
    { text: Arabic.PastWeek, callback_data: 'past_week' },
  ],
  [
    { text: Arabic.OnOrAfter, callback_data: 'on_or_after' },
    { text: Arabic.OnOrBefore, callback_data: 'on_or_before' },
  ],
  [
    { text: Arabic.After, callback_data: 'after' },
    { text: Arabic.Before, callback_data: 'before' },
    { text: Arabic.Equals, callback_data: 'equals' },
  ],
