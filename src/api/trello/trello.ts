...
export const Boards = {
  VideoBoard: { boardId: '60e6a69b5343fc3d2b82d5ff', name: 'لوح الفيديو', lists: { name: 'المهام', id: '60e6a820beeadf6d22e582c2' } },
  DesignBoard: { boardId: '60e6b8d80634d977dddcbe58', name: 'لوح التصميم', lists: { name: 'المهام', id: '620b63c83140a206c402aa6b' } },
  MarketingBoard: { boardId: '60e6bad7d727ed37b00026d2', name: 'لوح التسويق', lists: { name: 'المهام', id: '60e6bae3012ee15eb7fbdd3d' } },
  ManagementBoard: { boardId: '60e6ba19aecb55720a1a34fd', name: 'لوح الإدارة', lists: { name: 'المهام', id: '60e6ba24d6bf3d89a71f729a' } },
  TestBoard: { boardId: '641c924cef9a979adb5b60c8', name: 'لوح الاختبار', lists: { name: 'المهام', id: '641c92a4b19bc3713010d066' } },
};
// console.log(api)
